...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/git-book-kubernetes/flexsearch.min.js');loadScript('/git-book-kubernetes/en.search-data.min.33d6adff053cfe4ba146aeea3a8ceaf8866bc9373b42b9eea3aa98e4016ef6e6.js',function(){input.required=false;search();});}
